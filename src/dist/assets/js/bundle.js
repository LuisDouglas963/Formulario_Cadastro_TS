...
const isEmail_1 = __webpack_require__(/*! validator/lib/isEmail */ "./node_modules/validator/lib/isEmail.js");
...
form.addEventListener("submit", function (event) {
    ...
    if (shoulSendForm(this))
        console.log("Formulario enviado");
});
function checkForEmptyFields(...inputs) {
    inputs.forEach((input) => {
        if (!input.value)
            showErrorMessage(input, "Campo não preenchido");
    });
}
